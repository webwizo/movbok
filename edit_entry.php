            ...
            <div class="row">
               ...
               <div class="col-lg-4 col-md-4">
                  <div class="p-4 bg-white rounded overflow-hidden position-relative shadow-sm">
                     ...
                     <form name="sentMessage" id="contactForm"  action="do_edit_entry.php?id=<?php echo $id; ?>" method="post">
                        <div class="control-group form-group">
                           <div class="controls">
                              <label>Full Name <span class="text-danger">*</span></label>
                              <input type="text" placeholder="Full Name" class="form-control" id="name" name="fullname" value="<?php echo $row['fullname']; ?>">
                        ...
                        <div class="row">
                           <div class="control-group form-group col-md-6">
                              ...
                              <div class="controls">
                                 <input type="tel" placeholder="Phone Number" class="form-control" id="phone" name="phone" value="<?php echo $row['phone_number']; ?>">
                           ...
                           <div class="control-group form-group col-md-6">
                              <div class="controls">
                                 ...
                                 <input type="email" placeholder="Email Address" class="form-control" id="email" name="email" value="<?php echo $row['email_address']; ?>">
                                 <div class="help-block"></div>
                              </div>
                           </div>
                        </div>
                        <div class="control-group form-group mb-4">
                           <div class="controls">
                              ...
                              <textarea rows="5" cols="100" placeholder="Message" class="form-control" id="message" name="message" style="resize:none"><?php echo $row['message']; ?></textarea>
                              <div class="help-block"></div>
                           </div>
                        </div>
                        <div id="success"></div>
